...
private:			 
	...
	void ParsingData(std::wstring filePath, std::wstring fileName);
...
public:
	template <typename T>
	bool GetValue(_bool isStatic, std::wstring sectionKey, std::wstring objectKey, std::wstring varKey, T& result)
	{
